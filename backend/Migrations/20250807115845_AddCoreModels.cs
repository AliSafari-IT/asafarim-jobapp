        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditLogs_JobApplications_JobApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledFollowUpDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsFollowUpCompleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_JobApplicationId",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_JobApplicationId",
                table: "Feedbacks",
                column: "JobApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_DateApplied",
                table: "JobApplications",
                column: "DateApplied");
